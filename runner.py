...
u_ro = uniform_rollout_agent.UniformRolloutAgentClass(depth = 1, num_pulls = 10, policy = rand_agent1)
...
switch_agent = policy_switch_agent.PolicySwitchAgentClass(depth = 10, num_pulls = 50, policies = [u_ro, e_ro_d10_n10])

initial_state = pacman_sim.PacmanStateClass('originalClassic', e_ro_d10_n10)
