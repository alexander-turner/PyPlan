...
if __name__ == '__main__':
    ...
    dealer.run(simulator=sim, agents=[ss_d3, ss_d5], num_trials=10, show_moves=False)
    dealer.run(simulator=sim, agents=[ss_d5, uct], num_trials=10, show_moves=False)
    dealer.run(simulator=sim, agents=[uct, e_root_uct], num_trials=10, show_moves=False)
