...
"""
# TODO: double-check applicability of this demo
if __name__ == '__main__':
    ...
    switch_agent = policy_switch_agent.PolicySwitchAgentClass(depth=3, num_pulls=4, policies=[u_ro, ss])

    bad_switch_agent = policy_switch_agent.PolicySwitchAgentClass(depth=3, num_pulls=4, policies=[u_ro, bad_ss])
