from agents import *
from simulators import connect4_sim, dealer
...
if __name__ == '__main__':
    ...
    dealer.run(simulator=connect4, agents=[u_ro, nested_u_ro], num_trials=10, show_moves=False)
    dealer.run(simulator=connect4, agents=[u_ro, e_ro], num_trials=10, show_moves=False)
    dealer.run(simulator=connect4, agents=[nested_u_ro, nested_e_ro], num_trials=10, show_moves=False)
